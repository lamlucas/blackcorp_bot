 ...
 * Mỗi dòng → tin chi phí → ghi J = Done. Chỉ khi mọi dòng lọc (NGÀY+MCC) của khách đều Done
 * mới gửi TỔNG TIỀN + QR: Σ cột I + nợ đầu ngày cột C (CONG_NO; C = B lúc 00:00 giờ VN).
 */
