...
document.getElementById("sendSheetPayment").addEventListener("click", async () => {
  ...
  const dates = [...document.querySelectorAll("#sheetPayLinkRows input.sheet-pay-date-inp")]
    .sort((a, b) => Number(a.getAttribute("data-date-index") || 0) - Number(b.getAttribute("data-date-index") || 0))
