...
- Bot luu **chu ky (hash) tung dong** (cot A–G). Moi lan sync: **dong moi** (them o cuoi) hoac **dong cu bi sua** (bat ky o nao A–G) se **gui lai Telegram** cho dung nhom.
...
- Bot gui lai khi co **dong moi** hoac **noi dung dong da co thay doi** (cot A–G).
