...
let dealerLabelName = "Tên đại lý (tab Sheet chi phí, vd TINH_TIEN1)";
...
let dealerChatFootHintText =
  "Bấm « Lấy Chat ID nhóm » để nạp danh sách. « Tên đại lý » phải trùng tên tab Sheet chi phí (vd TINH_TIEN1) — có thể sửa sau khi Thêm.";
