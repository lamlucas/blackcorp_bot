...
/** Thu thập jobs gửi công nợ: đọc A2:B tab CONG_NO trên DEBT_SPREADSHEET_ID; mỗi cột A phải trùng (trim) tên tab trên MAIN_SPREADSHEET_ID (vd TINH_TIEN1); Chat ID = B1 tab đó hoặc KV dealer map. */
